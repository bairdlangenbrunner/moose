...
# OPEN TS DATASET
ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cmip5_calculations/ts/djf/NorESM1-M_ts_1970-00_climatology_djf.nc', 'r', format='NETCDF4')
...
ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/obs_calculations/ppe_obs_comparisons/obs_era_interim_72x144_skt_1970-2000_climatology_'+season+'.nc', 'r', format='NETCDF4')
obs_field_ts = ncfile.variables['skt'][ts_lat_inds[0]:(ts_lat_inds[-1]+1), ts_lon_inds[0]:(ts_lon_inds[-1]+1)]

# OPEN PR OBSERVATIONS
ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/obs_calculations/pr_gpcp/obs_GPCP_72x144_PRECT_1970-2000_climatology_'+season+'.nc', 'r', format='NETCDF4')
...
ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/obs_calculations/u200_MERRA/obs_MERRA_2.5x2.5_u200_1970-00_climatology_'+season+'.nc', 'r', format='NETCDF4')
...
for i in range(nmods):
	...
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cmip5_calculations/pr/'+season+'/'+modelname+'_pr_1970-00_climatology_'+season+'.nc', 'r', format='NETCDF4')
...
for i in range(len(LENS_names)): # 40
	...
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cesm_LENS_calculations/PRECC/'+season+'/'+member_name + '_PRECC_1970-00_climatology_'+season+'_2.5x2.5regrid.nc', 'r', format='NETCDF4')
	...
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cesm_LENS_calculations/PRECL/'+season+'/'+member_name + '_PRECL_1970-00_climatology_'+season+'_2.5x2.5regrid.nc', 'r', format='NETCDF4')
...
for i in range(nmods):
	...
	modelname = model_names[i]
	# OPEN HISTORICAL FIELDS
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cmip5_calculations/ts/'+season+'/'+modelname+'_ts_1970-00_climatology_'+season+'.nc', 'r', format='NETCDF4')
...
for i in range(len(LENS_names)): # 40
	member_name = LENS_names[i]
	# get convective precipitation
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cesm_LENS_calculations/TS/'+season+'/'+member_name + '_TS_1970-00_climatology_'+season+'_2.5x2.5regrid.nc', 'r', format='NETCDF4')
...
for i in range(nmods):
	...
	modelname = model_names[i]
	# OPEN HISTORICAL FIELDS
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cmip5_calculations/ua200/'+season+'/'+modelname+'_ua200_1970-00_climatology_'+season+'.nc', 'r', format='NETCDF4')
...
for i in range(len(LENS_names)): # 40
	member_name = LENS_names[i]
	# get convective precipitation
	ncfile = netCDF4.Dataset('/Volumes/data1/baird/subensembles_data/cesm_LENS_calculations/U200/'+season+'/'+member_name + '_U_1970-00_climatology_'+season+'_2.5x2.5regrid.nc', 'r', format='NETCDF4')
...
#DATESTRING = '2017-07-16_23:07:39'
DATESTRING = '2017-07-21_12:51:33'
open_dict = numpy.load('/Volumes/data1/baird/subensembles_analysis/sampling_k_values/data_files/pareto_front_results_'+DATESTRING+'_NO_LENS_model_combos.npy')

N_ens = open_dict[()]['N_ens']
model_combinations = open_dict[()]['model_combinations']
...
chunk_size = int(1e6)
chunks_whole = int(N_ens//chunk_size)
chunks_leftovers = int(N_ens%chunk_size)
...
# GET INFO BELOW FROM CHUNKS2.py
dict_names = numpy.array(( \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_0-1000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_1000000-2000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_2000000-3000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_3000000-4000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_4000000-5000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_5000000-6000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_6000000-7000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_7000000-8000000.npy', \
'pareto_front_results_2017-07-21_12:51:33_NO_LENS_partial_8000000-8347680.npy' ))

bias_values_subensembles_x = numpy.empty((0))
bias_values_subensembles_y = numpy.empty((0))
bias_values_subensembles_z = numpy.empty((0))

for i in range(dict_names.size):

	open_dict = numpy.load('/Volumes/data1/baird/subensembles_analysis/sampling_k_values/data_files/'+dict_names[i])

	bias_values_subensembles_x = numpy.append(bias_values_subensembles_x, open_dict[()]['bias_values_subensembles_x'])
	bias_values_subensembles_y = numpy.append(bias_values_subensembles_y, open_dict[()]['bias_values_subensembles_y'])
	bias_values_subensembles_z = numpy.append(bias_values_subensembles_z, open_dict[()]['bias_values_subensembles_z'])
	print('done with '+str(i+1)+' out of '+str(dict_names.size))
...
save_filename = 'pareto_front_results_'+DATESTRING+'_NO_LENS_partial_Pareto_fronts.npy'
